...
These are production goals for optimization reports. Current structural
validators enforce byte and schema gates; deeper triangle, vertex, bounds, and
texture-dimension inspection should be added before automated source promotion.
