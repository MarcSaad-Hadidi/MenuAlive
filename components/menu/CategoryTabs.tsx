...
export function CategoryTabs({
  ...
  const shell = isViewportInner
    ...
    : isPageHeader
      ? "sticky top-[4.75rem] z-30 min-w-0 border-b border-white/10 bg-[#080706]/96 px-3 py-2.5 backdrop-blur-md supports-[backdrop-filter]:bg-[#080706]/88 sm:top-[5.75rem]"
  ...
  const chipClass = (selected: boolean) =>
    isViewportInner
      ? `inline-flex min-h-11 max-w-full items-center justify-center whitespace-nowrap rounded-full border px-3 pb-[7px] pt-[5px] text-[12px] font-medium leading-[1.2] tracking-wide transition focus:outline-none focus-visible:ring-2 focus-visible:ring-champagne focus-visible:ring-offset-2 focus-visible:ring-offset-charcoal ${
          selected
      ...
      : `inline-flex min-h-11 max-w-full items-center justify-center whitespace-nowrap rounded-full border px-3.5 pb-[7px] pt-[5px] text-[12.5px] font-medium leading-[1.2] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-champagne focus-visible:ring-offset-2 focus-visible:ring-offset-charcoal sm:px-4 sm:pb-[8px] sm:pt-[6px] sm:text-sm ${
          selected
